...
Pod::Spec.new do |s|
  ...
  s.author             = { "HYOUNGBIN" => "jumice10@gmail.com" }
  # Or just: s.author    = "HYOUNGBIN"
  # s.authors            = { "HYOUNGBIN" => "jumice10@gmail.com" }
  # s.social_media_url   = "http://twitter.com/HYOUNGBIN"
  ...
  s.source       = { :git => "https://github.com/hyoungbin/KnobControl", :tag => '1.0.0' }
